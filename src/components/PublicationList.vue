    ...
    <div class="flex flex-col space-y-5">
        <div class="grid grid-cols-5">
            ...
            <div class="col-span-4">
                <p>WSI based prediction of <span class='italic'> TP53</span> mutations identifies aggressive disease phenotype in prostate cancer <button class="link">[arXiv]</button>
        ...
        <div class="grid grid-cols-5">
            ...
            <div class="col-span-4">
                <p>Self-supervised multimodel pre-training for lung adenocarcinoma overall survival prediction <button class="link">[arXiv]</button> 
                    <button class="link">[code]</button><button class="link">[cite]</button></p>
